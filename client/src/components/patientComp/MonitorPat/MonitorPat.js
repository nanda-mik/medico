...
import {setBloodpressure,setCal,setCovid,setPulse} from '../../../Redux/Patient/Patient.action';
...
class MonitorPatient extends Component{
    ...
    bphandler =(e) => {
        ...
        this.setState ({ bloodpressure: {...this.state.bloodpressure, date : time}})
    ...
    submitHandler =(e) => {
        ...
        e.preventDefault();
        const options = {
            url: 'http://localhost:8080/api/patient/saveMonitorData',
            method: 'POST',
            headers: {
       ...
       if(this.state.redirect){
        ...
        return(
            ...
            <div className="row">
                <Form onSubmit={this.submitHandler}>
                        ...
                        <Form.Group  controlId="formGridbloodPressure">
                            ...
                            onChange = {(e) => this.setState({bloodpressure: {...this.state.bloodpressure,systolic: e.target.value}})}
                        ...
                        <Form.Control 
                            ...
                            onChange = {(e) => this.setState({bloodpressure: {...this.state.bloodpressure,diastolic: e.target.value}})}
                            >
                 ...
                 <Form.Row>
                        <Form.Group controlId="formGriddiabetes">
                            ...
                            onChange = {(e) => this.setState({diabetes: {...this.state.diabetes,typeA: e.target.value}})}
                            >
                        ...
                        <Form.Control 
                            ...
                            onChange = {(e) => this.setState({diabetes : {...this.state.diabetes,typeB: e.target.value}})}
                            >
            ...
            <Form.Check
              name="cough"
              label="Cough"
              onChange={()=> this.setState({covid : {...this.state.covid , cough : !this.state.covid.cough}})}
              id="cough"
            />
            <Form.Check
              name="fever"
              label="Fever"
              onChange={()=> this.setState({covid : {...this.state.covid , fever : !this.state.covid.fever}})}
              id="fever"
            />
            <Form.Check
              name="tastebuds"
              label="Tastebuds not responding"
              onChange={()=> this.setState({covid : {...this.state.covid , tastebuds : !this.state.covid.tastebuds}})}
              id="tastebud"
            />
            <Form.Check
              name="dryThroat"
              label="Dry and sour throat"
              onChange={()=> this.setState({covid : {...this.state.covid , dryThroat : !this.state.covid.dryThroat}})}
              id="drythroat"
            />
            <Form.Check
              name="appetite"
              label="Loss of appetite"
              onChange={()=> this.setState({covid : {...this.state.covid , appetite : !this.state.covid.appetite}})}
              id="drythroat"
            />
          ...
          <Form.Group controlId="heartbeat">
              ...
              borderRadius: "30px",
              padding: "10px 40px"}} onClick={this.submitHandler}>Monitor</Button>
...
const mapDispatchToProps = dispatch => ({
    setBloodpressure : bloodpressure => dispatch(setBloodpressure(bloodpressure)),
