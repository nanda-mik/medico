...
class PatProfile extends Component {
          ...
          componentDidMount(){
            ...
            if(l>2||this.props.patientProfile===null){
                ...
                this.setState({
                    ...
                    loc : {...this.state.loc , zip : profdata.zip,state: profdata.state, city : profdata.city},
                    age : profdata.age,
                    gender : profdata.gender,
                    contact : {...this.state.contact , contact2 : profdata.contact2 , contact1 : profdata.contact1},
    ...
    submitHandler = (e) => {
        ...
        const options = {
            url: 'http://localhost:8080/api/patient/saveProfile',
            method: 'POST',
            headers: {
            ...
            <FormControl.Feedback type="invalid">
              Please provide a valid file.
                        ...
                        <Form.Label as={Row} column sm="2">
                            ...
                            <Col sm="10">
                                 <Form.Control plaintext readOnly defaultValue={profdata.email} />
                           </Col>
                       </Form.Group>
                        <Form.Row>
