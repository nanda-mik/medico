...
const navItems = [
  { id: 'Home', text: 'Home', link: '/', auth: false ,isPatient: false ,isDoc: false},
  { id: 'login', text: 'Login', link: '/login', auth: false ,isPatient: false,isDoc: false },
  { id: 'signup', text: 'Signup', link: '/signup', auth: false ,isPatient: false, isDoc: false},

  { id: 'dashboard', text: 'Dashboard', link: '/', auth: true ,isPatient: true, isDoc: false},
  { id: 'profile', text: 'Profile', link: '/patientProfile', auth: true ,isPatient: true, isDoc: false},
...
const navigationItems = props => [
  ...navItems.filter(item => item.auth === props.isAuth && item.isPatient === props.isPatient && item.isDoc === props.isDoc).map(item => (
    <li
      key={item.id}
