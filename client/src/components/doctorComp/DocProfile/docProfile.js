...
class DocProfile extends Component {
    ...
    componentDidMount(){
        ...
        if(l>2||this.props.profile===null){
            ...
            this.setState ({
                ...
                gender : data.gender,
                age : data.age,
                contact : {...this.state.contact , contact1 : data.contact1 , contact2 : data.contact2},
                qualification : {...this.state.qualification , university : data.university , specialization : data.specialization, honors : data.honors},
    ...
    submitHandler = (e) => {
        ...
        const options = {
            url: 'http://localhost:8080/api/doctor/saveProfile',
            method: 'POST',
            headers: {
                        ...
                        <Form.Row>
                            <Form.Group controlId="city">
                                <Form.Control
                                    ...
                                    onChange={(e) => this.setState({ loc: { ...this.state.loc, city: e.target.value } })}
                                >
                                </Form.Control>
                            </Form.Group>
                            <Form.Group controlId="state">
                                <Form.Control
                                    ...
                                    onChange={(e) => this.setState({ loc: { ...this.state.loc, state: e.target.value } })}
                                >
                                </Form.Control>
                            </Form.Group>
                            <Form.Group controlId="zip">
                                <Form.Control
                                    ...
                                    onChange={(e) => this.setState({ loc: { ...this.state.loc, zip: e.target.value } })}
                                >
                                </Form.Control>
                            </Form.Group>
                        </Form.Row>
                        <Form.Row>
                            <Form.Group controlId="contact">
                                <Form.Control
                                    ...
                                    onChange={(e) => this.setState({ contact: { ...this.state.contact, contact1: e.target.value } })}
                                >
                                </Form.Control>
                            </Form.Group>
                            <Form.Group controlId="contact2">
                                <Form.Control
                                    ...
                                    onChange={(e) => this.setState({ contact: { ...this.state.contact, contact2: e.target.value } })}
                                >
                                </Form.Control>
                            </Form.Group>
                        </Form.Row>
                        <Form.Row>
                            <Form.Group controlId="university">
                                <Form.Control
                                    ...
                                    onChange={(e) => this.setState({ qualification: { ...this.state.qualification, university: e.target.value } })}
                                >
                                </Form.Control>
                            </Form.Group>
                            <Form.Group controlId="specialization">
                                <Form.Control
                                    ...
                                    onChange={(e) => this.setState({ qualification: { ...this.state.qualification, specialization: e.target.value } })}
                                >
                                </Form.Control>
                            </Form.Group>
                            <Form.Group controlId="honors">
                                <Form.Control
                                    ...
                                    onChange={(e) => this.setState({ qualification: { ...this.state.qualification, honors: e.target.value } })}
                                >
                                </Form.Control>
                            </Form.Group>
                        </Form.Row>
