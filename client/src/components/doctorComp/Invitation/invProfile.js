            ...
            if(inv._id===this.props.match.params.id){
                ...
                <Card className="text-center">
                    <Card.Header>Patient's Information</Card.Header>
                     ...
                     <Card.Text>
                        I am {inv.name} of age {inv.age} . My gender is {inv.gender} . I am suffering from {inv.disease}.Looking forward to you giving me an appointment .
                        My brief description : {inv.aboutMe}
                    </Card.Text>
                    <Button variant="primary" onClick={this.submitHandler}>Accept Invitation</Button>
                </Card.Body>
